    ...
    def reset(self):
        ...
        for name, value in self._defaults.items():
            if isinstance(value, EventedModel):
                ...
                self.model_config.allow_mutation
                and self.model_fields[name].field_info.allow_mutation
            ):
