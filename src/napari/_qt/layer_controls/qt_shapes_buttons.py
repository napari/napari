...
class QtShapesButtons(QtLayerButtons):
    ...
    def __init__(self, layer) -> None:
        ...
        self.addWidget(self.move_back_button, 0, 0)
        self.addWidget(self.vertex_remove_button, 0, 1)
        self.addWidget(self.vertex_insert_button, 0, 2)
        self.addWidget(self.delete_button, 0, 3)
        self.addWidget(self.direct_button, 0, 4)
        self.addWidget(self.select_button, 0, 5)
        self.addWidget(self.move_front_button, 1, 0)
        self.addWidget(self.ellipse_button, 1, 1)
        self.addWidget(self.rectangle_button, 1, 2)
        self.addWidget(self.polygon_button, 1, 3)
        self.addWidget(self.polygon_lasso_button, 1, 4)
        self.addWidget(self.line_button, 1, 5)
        self.addWidget(self.polyline_button, 1, 6)
        self.addWidget(self.path_button, 1, 7)
