...
class Camera(EventedModel):
    ...
    angles : 3-tuple
        ...
        The angles are Euler rotations about the three displayed dimensions: rx
        rotates the camera about the depth axis (dim0, axis -3), ry about the
        vertical axis (dim1, axis -2), and rz about the horizontal axis (dim2,
        axis -1), applied in that order and right-handed (counterclockwise when
        looking along the axis toward the viewer). With all angles zero the
        camera shows the home view.
