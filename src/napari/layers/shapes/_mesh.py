...
class Mesh:
    ...
    def clear(self) -> None:
        ...
        self.vertices_index = np.empty((0, 2), dtype=IndexDtype)
        self.triangles = np.empty((0, 3), dtype=TriangleDtype)
        self.triangles_index = np.empty((0, 2), dtype=IndexDtype)
        ...
        self.displayed_triangles_index = np.empty((0, 2), dtype=IndexDtype)
