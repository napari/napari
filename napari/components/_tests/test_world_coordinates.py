...
def test_translated_images():
    ...
    viewer.add_image(data, translate=[0, 0, 0])
...
def test_scaled_images():
    ...
    np.random.seed(0)
    data = np.random.random((10, 10, 10))
    viewer.add_image(data, scale=[1, 1, 1])
...
def test_scaled_and_translated_images():
    ...
    np.random.seed(0)
    data = np.random.random((10, 10, 10))
    viewer.add_image(data, scale=[1, 1, 1], translate=[0, 0, 0])
...
def test_both_scaled_and_translated_images():
    ...
    np.random.seed(0)
    data = np.random.random((10, 10, 10))
    viewer.add_image(data, scale=[2, 1, 1], translate=[0, 0, 0])
