...
def test_translated_images():
    ...
    assert viewer.dims.range[0] == (-0.5, 19.5, 1)
    assert viewer.dims.range[1] == (-0.5, 9.5, 1)
    assert viewer.dims.range[2] == (-0.5, 9.5, 1)
...
def test_scaled_images():
    ...
    assert viewer.dims.range[0] == (-1, 9.5, 1)
    assert viewer.dims.range[1] == (-0.5, 9.5, 1)
    assert viewer.dims.range[2] == (-0.5, 9.5, 1)
...
def test_scaled_and_translated_images():
    ...
    assert viewer.dims.range[0] == (-0.5, 19, 1)
    assert viewer.dims.range[1] == (-0.5, 9.5, 1)
    assert viewer.dims.range[2] == (-0.5, 9.5, 1)
...
def test_both_scaled_and_translated_images():
    ...
    assert viewer.dims.range[0] == (-1, 39, 2)
    assert viewer.dims.range[1] == (-0.5, 9.5, 1)
    assert viewer.dims.range[2] == (-0.5, 9.5, 1)
    assert viewer.dims.nsteps == (20, 10, 10)
    for i in range(viewer.dims.nsteps[0]):
