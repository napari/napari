...
class LabelsPolygonOverlay(SceneOverlay):
    """Overlay that displays a polygon on a scene.
        ...
        - Mouse double click (left button): If there are at least three points in the polygon and
                      the double-click position is within completion_radius from the first vertex,
                      the polygon will be painted in the image using the current label.
