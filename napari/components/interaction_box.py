...
class InteractionBox(EventedModel):
    ...
    _box: Array[float, (-1, 2)] = None
    points: Array[float, (-1, 2)] = None
    show: bool = False
    show_handle: bool = False
    _show_vertices: bool = True
    _selected_vertex: int = None
    _fixed_vertex: int = None
    _drag_start_angle: float = None
    ...
    def __init__(self, points=None, show=False, show_handle=True):
        ...
        self.events.points.connect(self._create_box_from_points)
        self.events.points.connect(self._add_rotation_handle)
    ...
    def _create_box_from_points(self):
        ...
        if self.points is None or len(self._oints) < 1:
            self._box = None
            return
