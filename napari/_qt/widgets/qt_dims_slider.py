...
class QtDimSliderWidget(QWidget):
    ...
    def _set_slice_from_label(self):
        ...
        self.dims._point_step[self.axis] = val
    ...
    def _value_changed(self, value):
        ...
        """
        self.dims._point_step[self.axis] = value
    ...
    def _create_range_slider_widget(self):
        ...
        slider.setValue(self.dims._point_step[self.axis])
    ...
    def _update_range(self):
        ...
        if nsteps == 0:
            ...
            self.slider.setValue(self.dims._point_step[self.axis])
    ...
    def _update_slice_labels(self):
        ...
        self.curslice_label.setText(str(self.dims._point_step[self.axis]))
...
class AnimationWorker(QObject):
    ...
    def __init__(self, slider):
        ...
        # after dims._point_step is set, it will emit a dims.events._point_step()
        # we use this to update this threads current frame (in case it
        # was some other event that updated the axis)
        self.dims.events._point_step.connect(self._on_axis_changed)
        self.current = max(self.dims._point_step[self.axis], self.min_point)
    ...
    def advance(self):
        ...
        if self.current < self.min_point:
            ...
            if (
                ...
                return self.finish()
        with self.dims.events._point_step.blocker(self._on_axis_changed):
    ...
    def _on_axis_changed(self):
        ...
        self.current = self.dims._point_step[self.axis]
