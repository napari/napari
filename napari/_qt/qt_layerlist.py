...
class QtLayerList(QListWidget):
    ...
    def _selectionChanged(self):
        ...
        self.events.selected_layers(value=selected)
    ...
    def _reorder(self, event):
        ...
        """
        old_indices, new_indices = event.indices
        total = self.count() - 1
    ...
    def dropEvent(self, event: QEvent):
        ...
        self.events.reordered(value=(indices, tuple(range(total + 1))))
