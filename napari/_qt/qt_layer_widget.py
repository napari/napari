...
class QtLayerWidget(QFrame):
    ...
    def __init__(self, layer, parent=None):
        ...
        self.layer.events.name.connect(self._on_selected_change)
        ...
        cb.stateChanged[int].connect(lambda x: self.events.visible(value=x))
    ...
    def _on_selected_change(self, event):
        ...
        """
        self.setProperty('selected', event.value)
        self.nameTextBox.setEnabled(event.value)
    ...
    def changeText(self):
        ...
        if old_name == name:
            return
        self.events.name_unique(value=(old_name, name))
