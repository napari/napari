...
# TODO: we need to incorporate this into _open_or_get_error tests
...
# TODO: we need to incorporate this into function responding to multiple_plugins choice, including persistence
