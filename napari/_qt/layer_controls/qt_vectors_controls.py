...
class QtVectorsControls(QtLayerControls):
    ...
    def __init__(self, layer):
        ...
        self.grid_layout.addWidget(QLabel(trans._('projection:')), 4, 0)
        self.grid_layout.addWidget(self.projectionComboBox, 4, 1)
        self.grid_layout.addWidget(QLabel(trans._('edge color mode:')), 5, 0)
        self.grid_layout.addWidget(self.color_mode_comboBox, 5, 1, 1, 2)
        self.grid_layout.addWidget(self.edge_color_label, 6, 0)
        self.grid_layout.addWidget(self.edgeColorEdit, 6, 1, 1, 2)
        self.grid_layout.addWidget(self.edge_prop_label, 7, 0)
        self.grid_layout.addWidget(self.color_prop_box, 7, 1, 1, 2)
        self.grid_layout.addWidget(QLabel(trans._('out of slice:')), 8, 0)
        self.grid_layout.addWidget(self.outOfSliceCheckBox, 8, 1)
        self.grid_layout.addWidget(
            QLabel(trans._('fixed canvas width:')), 9, 0
        )
        self.grid_layout.addWidget(self.fixedCanvasWidthCheckBox, 9, 1)
