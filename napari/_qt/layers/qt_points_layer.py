...
class QtPointsControls(QtLayerControls):
    def __init__(self, layer):
        ...
        if layout_option == 1:
            ...
            self.grid_layout.addWidget(QLabel('face color:'), 4, 0, 1, 3)
            self.grid_layout.addWidget(self.faceComboBox, 4, 3, 1, 4)
            self.grid_layout.addWidget(QLabel('edge color:'), 4, 0, 1, 3)
            self.grid_layout.addWidget(self.edgeComboBox, 4, 3, 1, 4)
            self.grid_layout.addWidget(QLabel('symbol:'), 6, 0, 1, 3)
            self.grid_layout.addWidget(self.symbolComboBox, 6, 3, 1, 4)
