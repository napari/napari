...
class QtShapesControls(QtLayerControls):
    def __init__(self, layer):
        ...
        self.vbox_layout.addWidget(self.direct_button)
        self.vbox_layout.addWidget(self.vertex_insert_button)
        self.vbox_layout.addWidget(self.vertex_remove_button)
        self.vbox_layout.addWidget(self.rectangle_button)
        self.vbox_layout.addWidget(self.ellipse_button)
        self.vbox_layout.addWidget(self.line_button)
        self.vbox_layout.addWidget(self.path_button)
        self.vbox_layout.addWidget(self.polygon_button)
        self.vbox_layout.addWidget(self.move_front_button)
        self.vbox_layout.addWidget(self.move_back_button)
