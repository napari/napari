...
class QtImageControls(QtBaseImageControls):
    def __init__(self, layer):
        ...
        self.grid_layout.addWidget(QLabel('rendering:'), 5, 0)
        self.grid_layout.addWidget(self.renderComboBox, 5, 1, 1, 2)
        self.grid_layout.addWidget(QLabel('interpolation:'), 6, 0)
        self.grid_layout.addWidget(self.interpComboBox, 6, 1, 1, 2)
