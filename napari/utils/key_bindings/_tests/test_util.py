...
def test_key2mod():
    ...
    def test_create_conflict_filter():
        key_seqs = [
            ...
            KeyMod.CtrlCmd | KeyCode.Shift | KeyCode.KeyB,
            KeyMod.Alt,
            KeyChord(
        ...
        assert set(filter(alt_fltr, key_seqs)) == {}
