default_shortcuts = {
    ...
    'napari:activate_points_select_mode': ['2'],
    'napari:activate_points_add_mode': ['3'],
    ...
    'napari:activate_direct_mode': ['5'],
    'napari:activate_shape_pan_zoom_mode': ['6'],
    'napari:activate_vertex_insert_mode': ['4'],
    'napari:activate_vertex_remove_mode': ['3'],
    'napari:activate_select_mode': ['2'],
    'napari:copy_selected_shapes': ['Control-C'],
    'napari:paste_shape': ['Control-V'],
    'napari:select_all_shapes': ['A'],
    'napari:delete_selected_shapes': ['Backspace', 'Delete', '1'],
