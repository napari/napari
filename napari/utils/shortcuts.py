default_shortcuts = {
    ...
    'napari:select_all_in_slice': ['Control-A'],
    'napari:select_all_shown_in_slice': ['A'],
    'napari:select_all_data': ['Control-Shift-A'],
    'napari:select_all_shown_data': ['Shift-A'],
    ...
    'napari:transform_active_layer': ['Meta-Shift-A', 'Alt-Shift-A'],
}
