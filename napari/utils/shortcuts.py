...
_default_shortcuts = {
    ...
    'napari:activate_labels_fill_mode': [KeyCode.Digit3, KeyCode.KeyF],
    'napari:activate_labels_picker_mode': [KeyCode.Digit4, KeyCode.KeyL],
    'napari:activate_labels_pan_zoom_mode': [KeyCode.Digit5, KeyCode.KeyZ],
    'napari:activate_labels_transform_mode': [KeyCode.Digit6],
    'napari:activate_labels_polygon_mode': [KeyCode.Digit7],
