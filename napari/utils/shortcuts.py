...
default_shortcuts = {
    ...
    'napari:activate_direct_mode': [KeyCode.Digit5],
    'napari:activate_select_mode': [KeyCode.Digit2],
    'napari:activate_shape_pan_zoom_mode': [KeyCode.Digit6],
    'napari:activate_vertex_insert_mode': [KeyCode.Digit4],
    'napari:activate_vertex_remove_mode': [KeyCode.Digit3],
