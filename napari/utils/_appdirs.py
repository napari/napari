...
user_data_dir = partial(appdirs.user_data_dir, _appname, _appauthor)
user_config_dir = partial(appdirs.user_config_dir, _appname, _appauthor)
user_cache_dir = partial(appdirs.user_cache_dir, _appname, _appauthor)
user_state_dir = partial(appdirs.user_state_dir, _appname, _appauthor)
user_log_dir = partial(appdirs.user_log_dir, _appname, _appauthor)
