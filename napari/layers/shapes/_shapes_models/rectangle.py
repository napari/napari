...
class Rectangle(Shape):
    ...
    edge_color : str or array-like
        Color of the shape marker border. Strings can be color names of hex
        values (starting with `#`). Array-like should have 3 or 4 elements
        per row in an RGB(A) format, and can either be of length 1 or the exact
        length of `data`.
    face_color : str or array-like
        Color of the shape marker body. Strings can be color names of hex
        values (starting with `#`). Array-like should have 3 or 4 elements
        per row in an RGB(A) format, and can either be of length 1 or the exact
        length of `data`.
    opacity : float
