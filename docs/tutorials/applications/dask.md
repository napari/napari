...
![image: dask array html representation](../assets/dask_repr.png)
...
![image: mCherry-H2B showing chromosome separation during mitosis. Collected on a lattice light sheet microscope](../assets/dask1.gif)
...
![image: same dataset, demonstrating on-the-fly read → deskew → deconvolve → crop](../assets/dask2.gif)
