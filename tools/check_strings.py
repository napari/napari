...
SKIP_WORDS = {
    ...
    'napari/_qt/dialogs/qt_plugin_report.py': [
        ...
        '</a>',
        '<span style="color:#999;">plugin home page:&nbsp;&nbsp;</span><a href="',
    ...
    'napari/_qt/qt_resources/_qt_resources_0.4.5.dev9+g577de77_pyqt5_5.9.7.py': [
        '.',
        '0',
        '5',
        '8',
    ...
    'napari/_qt/qt_resources/_icons.py': [
        ...
        'Cannot compile QRC. Unexpected qtpy API name: ',
        'Failed to build PySide2 resources ',
        'NAPARI_REBUILD_RESOURCES',
        'PyQt5',
        'PySide2',
        'PySide2 rcc binary not found in ',
        '_',
        '_qt_resources_',
    ...
    'napari/_qt/qt_resources/__init__.py': [
        '*.qss',
        'QColoredSVGIcon',
        '_register_napari_resources',
        'compile_qt_svgs',
    ...
    'napari/_qt/qt_resources/_qt_resources_PyQt5_5_9_7_9e6fe1a88d30d1b7988f9d8351e8c3e4.py': [
        '.',
        '0',
        '5',
        '8',
    ...
    'napari/_qt/containers/_factory.py': [
        'Cannot create Qt model for obj: ',
        'Cannot create Qt view for obj: ',
    ],
    'napari/_qt/containers/qt_tree_model.py': [
        ...
        'dropMimeData: indices ',
        'nested_index must be an int or tuple of int.',
        'root node must be an instance of ',
        'text/plain',
    ],
    ...
    'napari/_qt/perf/qt_debug_menu.py': [
        '.json',
        'Alt+T',
        'Shift+Alt+T',
        'Stop Recording',
    ...
    'napari/_qt/widgets/qt_highlight_preview.py': [
        'Maximum value must be larger than ',
        'Minimum value must be smaller than ',
    ...
    'napari/_qt/widgets/qt_viewer_dock_widget.py': [
        ...
        'all allowed_areas argument must be in ',
        'area argument must be in ',
        'bottom',
        'dockWidgetArea',
        'left',
        'right',
    ...
    'napari/_qt/qt_event_loop.py': [
        ...
        'A QApplication is already running with ',
        'IPython',
        'No Qt app has been created. One can be created by calling `get_app()` or qtpy.QtWidgets.QApplication([])',
        "QApplication already existed, these arguments to to 'get_app' were ignored: {}",
        'Refusing to run a QApplication with no topLevelWidgets. To run the app anyway, use `',
        'app_id',
        'app_name',
        'app_version',
        'frozen',
    ...
    'napari/_qt/qthreading.py': [
        ' cannot be used with FunctionWorker, use GeneratorWorker instead',
        ' cannot be used with GeneratorWorker, use FunctionWorker instead',
        ' ms)',
        ' must be a subclass of WorkerBase',
        '"',
        '" failed to define work() method',
        '"_connect[',
        'Generator function ',
        'Regular function ',
        ...
        'Worker ',
        'WorkerBase',
        'Workers did not quit gracefully in the time allotted (',
        ']" must be a function or sequence of functions',
        '_connect',
        '_connect parameter must be a dict',
        '_ignore_errors',
        '_start_thread',
        '_worker_class',
        'errored',
    ...
    'napari/utils/tree/node.py': [
        '\n',
        'Cannot unparent orphaned Node: {self!r}',
        'Node',
    ],
    'napari/utils/settings/__init__.py': [],
    'napari/utils/settings/_defaults.py': [
        ', ',
        'Use interactive %gui qt event loop when creating napari Viewers in IPython',
    ...
    'napari/utils/transforms/transforms.py': [
        '. For other matrices, set the affine_matrix or linear_matrix directly.',
        'Affine',
        'Cannot subset arbitrary transforms.',
        'Inverse function was not provided.',
        'Only upper triangular or lower triangular matrices are accepted for shear, got ',
        'ScaleTranslate',
        'Transform',
        'Transform composition rule not provided',
        'TransformChain',
    ],
    'napari/utils/transforms/transform_utils.py': [
        '%d is a strange number of shear elements',
        'Improper transform matrix ',
    ...
    'napari/utils/events/containers/_nested_list.py': [
        ' to TypedList expecting type ',
        ')',
        ', dest_index=',
        '. Must be an int or tuple',
        "Can't yet deal with slice source indices in multimove",
        'Cannot add object with type ',
    ...
    'napari/utils/events/containers/_selectable_list.py': [
        'Cannot select item that is not in list: ',
        '_T',
    ],
    ...
    'napari/utils/events/event.py': [
        ...
        '<{} {}>',
        '=',
        'Cannot unblock %s for callback %s; emitter was not previously blocked.',
        'Emitter must be specified as either an EventEmitter instance or Event subclass. (got %s=%s)',
        'EmitterGroup',
        ...
        '__name__',
        'always',
        'cannot place callback before "%s" and after "%s" for callbacks: %s',
        'criteria "%s" is in the current callback list %s times:\n%s\n%s',
        'first',
        'last',
        'never',
        'on_%s',
        'position must be "first" or "last", not %s',
    ...
    'napari/utils/perf/_patcher.py': [
        ...
        'Module ',
        'Module not found: ',
        'Nested attribute not found: ',
        'Parent ',
        'Patcher: [ERROR] ',
        'Patcher: [WARN] skipping duplicate ',
        'Patcher: patching ',
    ],
    ...
    'napari/utils/colormaps/vendored/cm.py': [
        ', ',
        'Arguments must include a name or a Colormap',
        'Colormap %s is not recognized. Possible values are: %s',
        'Colormap name must be a string',
    ...
    'napari/utils/colormaps/vendored/colorconv.py': [
        ...
        'D75',
        'E',
        'Expected 2D, 3D, or 4D array, got %iD.',
        "Unknown illuminant/observer combination        ('{0}', '{1}')",
        'got (',
        'ignore',
        'the background must be a tuple with 3 items - the RGB color of the background. Got {0} items.',
        'the input array must be have a shape == ([ ..,] 3)), ',
        'the input array must have a shape == ([ ..,] 4)), got {0}',
    ],
    ...
    'napari/utils/colormaps/vendored/colors.py': [
        '"blend_mode" must be callable or one of {}',
        '#',
        '02x',
        'Abstract class only',
        'BoundaryNorm is not invertible',
        'Invalid RGBA argument: {!r}',
        ...
        'Unexpected value for extend: {0!r}',
        'With extend == {0!r} and n_levels == {1!r} expected n_colors == {2!r}. Got {3!r}.',
        '\\A#[a-fA-F0-9]{6}\\Z',
        '\\A#[a-fA-F0-9]{8}\\Z',
        '_r',
        'alpha',
    ...
    'napari/utils/colormaps/standardize_color.py': [
        ...
        ' at index ',
        ' columns. Converting input to a white color array.',
        ' dimensions.',
        '#',
        '#00000000',
        '%02x',
        ...
        'Given colors input should contain one or two dimensions. Received array with ',
        'Given colors input should contain three or four columns. Received array with ',
        'Invalid color found: ',
        'O',
    ...
    'napari/utils/colormaps/colormap_utils.py': [
        '" not found in either vispy or matplotlib.',
        '. Must be a {str, tuple, dict, napari.utils.Colormap, vispy.colors.Colormap}',
        'Colormap "',
    ...
    'napari/utils/_register.py': [
        ...
        '\n\nReturns\n-------\n',
        ' ',
        ' layer to the layer list. ',
        ' layer.',
        " should not include 'layer'",
        'Add a',
        '`',
        'add_',
        'aeiou',
    ...
    'napari/utils/misc.py': [
        ' \\1',
        ' is not a directory.',
        ' may only be called with a `str` or an instance of ',
        ' must equal ',
    ...
    'napari/utils/key_bindings.py': [
        " already used! specify 'overwrite=True' to bypass this check",
        ' to be callable',
    ...
    'napari/utils/_testsupport.py': [
        '--show-napari-viewer',
        'CanvasBackendDesktop',
        'Widgets leaked!: ',
        "don't show viewer during tests",
        'function',
        'last_value',
        'show',
        'store_true',
    ...
    'napari/utils/validators.py': [
        ' is of type ',
        "' is not an indexable collection (list, tuple, or np.array), of length ",
        ', but ',
        ', got ',
        'Every item in the sequence must be of type ',
    ...
    'napari/utils/io.py': [
        ...
        '"',
        '" not recognized as ',
        '" not recognized as valid Layer data',
        '([0-9]+)',
        '*.*',
        ',',
        '.',
    ...
    'napari/utils/translations.py': [
        ...
        'The `language` setting defined in the napari configuration file could not be read. The default language will be used.\n\nError: \n',
        'The following locales are invalid: ',
        '_',
        'application',
        'displayName',
        'language',
    ...
    'napari/utils/_tracebacks.py': [
        ...
        '</span>',
        '<br>\n',
        '<br><br><font color="#51B432">During handling of the above exception, another exception occurred:</font><br>',
        '<br><br><font color="#51B432">The above exception was the direct cause of the following exception:</font><br>',
        '<br>\\1<br>',
    ...
    'napari/utils/_magicgui.py': [
        ' (data)',
        ' annotated with a return type of napari.types.LayerDataTuple did not return LayerData tuple(s)',
        'CategoricalWidget',
        'Data',
        'add_',
        'magicgui function ',
    ...
    'napari/utils/interactions.py': [
        ...
        '.',
        '</b></span>',
        "</span></td><td style='text-align: left; padding: 4px; color: #CCC;'>",
        '</table>',
        '</td></tr>',
        "<span style='color: ",
        '<table border="0" width="100%">',
        "<tr><td width='80' style='text-align: right; padding: 4px;'><span style='color: rgb(66, 72, 80)'>",
        'Alt',
        'Backspace',
        'Control',
        'Ctrl',
    ...
    'napari/utils/info.py': [
        ' ',
        '  - ',
        '  - failed to load screen information ',
    ...
    'napari/utils/dask_utils.py': [
        '2.15.0',
        'For best performance with Dask arrays in napari, please upgrade Dask to v2.15.0 or later. Current version is ',
        'dask_cache',
    ...
    'napari/plugins/io.py': [
        ...
        ' layers to ',
        ' of writing this combination of layer types: ',
        '" is not capable',
        ...
        ', ...] as stack',
        '.',
        'No data written! There may be no plugins capable of writing these ',
        'No plugin found capable of reading ',
        'Plugin ',
        'Requested plugin "',
        'See full error logs in "Plugins → Plugin Errors..."',
        "There is no registered plugin named '",
        'Unable to find plugin capable',
        '[',
        'napari_write_',
        'occurred in plugins: ',
        's',
    ...
    'napari/plugins/__init__.py': [
        ...
        ' does not provide a widget named ',
        ' does not provide any dock widgets',
        ' for class ',
        ' in the dict returned by ',
        ' provided a non-callable object (widget) to ',
        ' provided a non-callable type to ',
        ' provided a non-dict object to ',
        ' provided an invalid dict object for key ',
        ' provided an invalid tuple to ',
        ' provided invalid data for key ',
        ' provided invalid kwargs to ',
        ' provides more than 1 dock_widget. Must also provide "widget_name" from ',
        ' that does not have required keys: "data" and "display_name".  Ignoring',
        ').',
        ', plugin ',
        '.  Skipping',
        '. (Must be str, callable, or dict), got (',
        '. Function widget ignored.',
        '. Widget ignored.',
        ': ',
        ': data ignored.',
        'FunctionGui',
        'In ',
        'Plugin ',
        "Plugin '{}' has already registered a dock widget '{}' which has now been overwritten",
        "Plugin '{}' has already registered a function widget '{}' which has now been overwritten",
        'PluginManager',
        'QWidget',
        '_',
    ...
    'napari/layers/tracks/tracks.py': [
        ...
        ' not available',
        ' not present in new properties. Falling back to track_id',
        'Colormap ',
        'Previous color_by key ',
        'additive',
        'color_by',
        'colormap',
        'colormaps_dict',
    ...
    'napari/layers/tracks/_track_utils.py': [
        ' not found',
        'ID:',
        'Property ',
        'graph node ',
        ...
        'track_id',
        'tracks should be ordered by ID and time',
    ],
    ...
    'napari/layers/surface/surface.py': [
        ...
        'Surface data tuple must be 2 or 3, specifyingverictes, faces, and optionally vertex values,instead got length ',
        'colormap',
        'contrast_limits',
        'data',
        'gamma',
    ...
    'napari/layers/shapes/_shapes_models/shape.py': [
        ...
        'int',
        'mask shape length must either be 2 or the same\n            as the dimensionality of the shape, expected ',
        'rectangle',
    ],
    'napari/layers/shapes/_shapes_models/ellipse.py': [
        ' provided.',
        'Data shape does not match a ellipse.\n                             Ellipse expects four corner vertices,\n                             ',
        'ellipse',
        'int',
    ],
    ...
    'napari/layers/shapes/shapes.py': [
        ...
        '_color_mode',
        '_color_property',
        '_color_property was not set, setting to: ',
        '_colormap',
        '_contrast_limits',
        '_current_',
        'black',
    ...
    'napari/layers/utils/_text_utils.py': [
        ')',
        ') should equal the length of the data (',
        ':',
    ...
    'napari/layers/utils/stack_utils.py': [
        ' layer ',
        ' values. ',
        "' argument only provided ",
        ') had length ',
        ", but the '",
        '.\nRequested channel_axis (',
        "Can't split along axis {}. The image has {} dimensions",
    ...
    'napari/layers/utils/_link_layers.py': [
        ' on ',
        ' to that of ',
        '. Allowable attrs include:\n',
        'Cannot link attributes that are not shared by all layers: ',
        'Layer',
    ...
    'napari/layers/utils/color_transformations.py': [
        ' entries, while the data contains ',
        ' entries. Setting ',
        ' parameter contained illegal values, resetting all ',
        ' parameter has ',
        ' to ',
        ' values to ',
        ', while the number of colors is ',
        '.',
        '. Color for all points is reset to white.',
        'The number of supplied colors mismatch the number of given data points. Length of data is ',
        'The provided ',
    ],
    ...
    'napari/layers/image/experimental/octree.py': [
        ...
        'Multiscale data has downsampling ratio of ',
    ...
    'napari/layers/image/_image_utils.py': [
        'Input data should be an array-like object, or a sequence of arrays of decreasing size. Got arrays in incorrect order, shapes: ',
        'Input data should be an array-like object, or a sequence of arrays of decreasing size. Got arrays of single shape: ',
        'dtype',
        'image',
        'labels',
        'ndim',
    ...
    'napari/layers/base/base.py': [
        ...
        '_round_index',
        'affine input not recognized. must be either napari.utils.transforms.Affine or ndarray. Got ',
        'affine input not recognized. must be either napari.utils.transforms.Affine, ndarray, or None. Got ',
        'blending',
        'constant',
        'data',
        'data world step',
    ...
    'napari/components/experimental/chunk/_commands/_tables.py': [
        ' ',
        ' columns not compatible with headers (',
        ' columns)',
        ': ',
        '<',
        '>',
    ...
    'napari/components/viewer_model.py': [
        ' available yet.',
        ' does not provide sample data named ',
        ' is a valid layer type, but there is no viewer.add_',
        ...
        'Plugin ',
        'Ready',
        "Received sequence for argument '",
        'Sorry! ',
        'The second item in a LayerData tuple must be a dict',
        'The third item in a LayerData tuple must be one of: ',
        "Theme '",
        "Unrecognized layer_type: '",
        '_add_layer_from_data received an unexpected keyword argument (',
        '_mouse_drag_gen',
        '_mouse_wheel_gen',
    ...
    'napari/components/dims.py': [
        ' dimensions',
        ' for ',
        ' not defined for dimensionality ',
        ').',
        ', ',
        '. Must be in [',
        'Axis ',
    ...
    'napari/_vispy/experimental/texture_atlas.py': [
        ' is not compatible with this TextureAtlas2D which has tile shape ',
        'Data with shape ',
    ],
    ...
    'napari/_vispy/vendored/volume.py': [
        ...
        'Volume visual needs a 3D image.',
        'Volume visual needs a numpy array.',
        'a_position',
        'a_texcoord',
        'additive',
        'clamp_to_edge',
        'clim',
        'clim must be a 2-element array-like',
        'cmap',
        'document',
        'float32',
        'gamma',
        ...
        'mip',
        'nearest',
        'relative_step_size cannot be smaller than 0.1',
        'sample',
        'sampler_type',
        'texture2D_LUT',
        'texture_lut',
    ...
    'napari/_vispy/vendored/image.py': [
        ...
        ', ',
        "Unknown image draw method '%s'",
        'a_position',
        'a_texcoord',
        'auto',
        'bilinear',
        'clim',
        'clim must be "auto" if a string',
        'clim must have two elements',
        'color_transform',
        'float cmap(vec4 color) { return (color.r + color.g + color.b) / 3.; }',
        'float32',
        'gamma',
        'gamma must be > 0',
        'get_data',
        ...
        'triangles',
        'u_kernel',
        'vec4 pass(vec4 color) { return color; }',
        'viridis',
    ],
    'napari/_vispy/vispy_image_layer.py': [
        ' cannot exceed GL_MAX_TEXTURE_SIZE ',
        ' exceeds GL_MAX_TEXTURE_SIZE ',
        ' in at least one axis and will be downsampled. Rendering is currently in ',
        '. Rendering is currently in ',
        'D mode.',
        'Shape of individual tiles in multiscale ',
        'auto',
        'data shape ',
        'tile2data',
    ],
    ...
    'napari/_vispy/utils_gl.py': [
        ' not allowed for texture; must be one of ',
        'type ',
    ],
    ...
    'napari/_vispy/vispy_axes_visual.py': [
        ...
        'Either 2 or 3 colors must be provided, got ',
        'canvas',
        'center',
        'gl',
        'segments',
    ...
    'napari/_vendor/experimental/cachetools/cachetools/cache.py': [
        '%s(%r, maxsize=%r, currsize=%r)',
        'value too large',
    ],
    'napari/_vendor/experimental/cachetools/cachetools/__init__.py': [
        '4.1.1',
        'Cache',
        'LFUCache',
        'LRUCache',
    ...
    'napari/_vendor/experimental/cachetools/cachetools/keys.py': [
        'hashkey',
        'typedkey',
    ],
    'napari/_vendor/experimental/cachetools/cachetools/rr.py': ['%s is empty'],
    'napari/_vendor/experimental/cachetools/cachetools/ttl.py': [
        '%s is empty',
        'expire',
        'key',
        'next',
    ...
    'napari/_vendor/experimental/cachetools/cachetools/lru.py': [
        '%s is empty'
    ],
    'napari/_vendor/experimental/cachetools/cachetools/lfu.py': [
        '%s is empty'
    ],
    'napari/_vendor/experimental/cachetools/cachetools/func.py': [
        'CacheInfo',
        'currsize',
        'hits',
        'lfu_cache',
    ...
    'napari/_vendor/experimental/cachetools/cachetools/abc.py': [
        '__missing__'
    ],
    'napari/_vendor/experimental/cachetools/cachetools/decorators.py': [],
    'napari/_vendor/experimental/cachetools/__init__.py': [],
    'napari/_vendor/experimental/humanize/src/humanize/time.py': [
        ' and ',
        '%0.2f',
        '%b %d',
        '%b %d %Y',
    ...
    'napari/_vendor/experimental/humanize/src/humanize/number.py': [
        ' ',
        ' x 10',
        '%.1f',
        '+',
    ...
    'napari/_vendor/experimental/humanize/src/humanize/filesize.py': [
        '%.1f',
        '%d Byte',
        '%d Bytes',
        '%dB',
    ...
    'napari/_vendor/experimental/humanize/src/humanize/__init__.py': [
        '2.5.0',
        'VERSION',
        '__version__',
        'activate',
    ...
    'napari/_vendor/experimental/humanize/src/humanize/i18n.py': [
        '\x04',
        "Humanize cannot determinate the default location of the 'locale' folder. You need to pass the path explicitly.",
        'activate',
        'deactivate',
        'gettext',
        'humanize',
    ...
    'napari/_vendor/qt_json_builder/qt_jsonschema_form/widgets.py': [
        '#f6989d',
        '#ffffff',
        '.',
        '.state',
        ...
        '<b>.',
        'Browse',
        'Cannot handle nested error by default',
        'Errors',
        'Preferences',
        'WidgetBuilder',
        'additionalItems',
    ...
    'napari/_vendor/qt_json_builder/qt_jsonschema_form/form.py': [
        'array',
        'boolean',
        'checkbox',
        'colour',
    ...
    'napari/_vendor/qt_json_builder/qt_jsonschema_form/defaults.py': [
        'array',
        'default',
        'enum',
        'items',
    ...
    'napari/conftest.py': [
        ...
        '.tif',
        '0',
        'Legacy skimage image_fetcher cannot find file: ',
        '_PYTEST_RAISE',
        'async_only',
        'camera',
        'coins',
    ...
    'napari/_version.py': [
        '0.4.7.dev82+g18c647c.d20210406',
        'd20210406',
        'dev82+g18c647c',
    ],
    'napari/__init__.py': [
    ...
    'napari/view_layers.py': [
        ...
        '(**_kw)\n        return viewer',
        ':',
        'Create a viewer and add a{n} {name} layer.\n\n{params}\n\nReturns\n-------\nviewer : :class:`napari.Viewer`\n    The newly-created viewer.\n',
        'List',
        "No Viewer method named '",
        'NoneType',
        'Optional',
        'Parameters',
        'Sequence',
    ...
    'napari/__main__.py': [
        ...
        'TYPE',
        'WIDGET_NAME',
        'When providing a python script, only a single positional argument may be provided',
        '_',
        '__main__',
        'bin',
        ...
        'force file to be interpreted as a specific layer type. one of ',
        'increase output verbosity',
        'napari',
        'napari version ',
        'open napari with dock widget from specified plugin name.(If plugin provides multiple dock widgets, widget name must also be provided)',
        ...
        'show information about plugins and exit',
        'show system information and exit',
        'specify plugin name when opening a file',
        'store_true',
        'version',
        'with_',
    ...
    for fpath in paths:
        ...
        for string in all_strings:
            ...
            if (
                ...
                and value not in skip_words
                and string != ""
            ):
                issues[fpath].append(value)

        # print(repr(fpath) + ": " + repr(sorted(issues[fpath])) + ",")
