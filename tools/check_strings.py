...
SKIP_WORDS_GLOBAL = [", ", "."]
SKIP_WORDS = {
    'napari/__init__.py': ['1', 'SPARSE_AUTO_DENSIFY', 'not-installed'],
    ...
    'napari/_qt/qthreading.py': [
        '"_connect["The \'_connect\' argument must be a dict"]" must be a function or ',
        '"{self.__class__.__name__}" failed to define work() method',
        'FunctionWorker, use GeneratorWorker instead',
        'Generator function {func} cannot be used with ',
        'GeneratorWorker, use FunctionWorker instead',
        'Regular function {func} cannot be used with ',
    ...
    'napari/_vispy/vispy_scale_bar_visual.py': [
        ...
        'gl',
        'segments',
        '{target_world_pixels_rounded:.4g}',
    ],
    ...
    'napari/components/experimental/monitor/_monitor.py': [
        '0',
        'Monitor: Config file not found: napari/',
    ...
    'napari/layers/shapes/shapes.py': [
        ...
        '_{attribute}_color_property was not set, ',
    ...
    'napari/utils/notebook_display.py': ['png'],
    ...
    'napari/utils/translations.py': [
        'The `language` setting defined in the napari configuration file could not be read.\n\nThe default language will be used.\n\nError:\n{err}',
        'LANG',
        'LANGUAGE',
        'NAPARI_LANGUAGE',
        '_',
    ...
    'napari/utils/tree/node.py': ['Node', '{self!r}'],
    ...
    'napari/view_layers.py': [
        ...
        'add_{layer_string}',
        'aeiou',
        'def view_{layer_string}{combo_sig}:',
        'exec',
        'image',
        'labels',
        'n',
...
def _find_func_definitions(node, defs=[]):
    """
...
def find_docstrings(fpath: str):
    ...
    #             function_definitions.append(item)
...
def find_strings(fpath: str):
    ...
    -------
    tuple
        A tuple of tuples for the line number and the string found.
    """
    strings = {}
...
def find_trans_strings(fpath: str):
    """
...
def import_module_by_path(fpath):
...
def find_untranslated_strings(paths, skip_words):
    """"""
    issues = {}
    for fpath in paths:
        print(fpath)
...
if __name__ == "__main__":
    ...
    if issues:
        print(
            ...
            "or added to the skip list on the `tools/check_strings.py` "
            "file.\n\n"
        )
        ...
        # new = {}
        # for key in sorted(SKIP_WORDS):
        #    new[key] = list(sorted(SKIP_WORDS[key]))
